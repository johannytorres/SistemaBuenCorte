...
{
    /// <inheritdoc />
    public partial class AgregarVentasFacturasCajaDescuentoReporte : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MontoCierreContado = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetodoPago = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Total = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    NombreCliente = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Descuentos",
                columns: new[] { "Id", "Activo", "Nombre", "Tipo", "Valor" },
                values: new object[,]
                {
                    { 1, true, "Descuento empleado", "Porcentaje", 10.00m },
                    { 2, true, "Promoción del día", "MontoFijo", 50.00m }
                });
